...
class PembacaPolicy
{
    ...
    {
        return $user->can('view_any_pembaca');
    }
    ...
    {
        return $user->can('create_pembaca');
    }
    ...
    {
        return $user->can('update_pembaca');
    }
    ...
    {
        return $user->can('delete_pembaca');
    }
    ...
    {
        return $user->can('delete_any_pembaca');
    }
     ...
     */
    public function replicate(User $user, Pembaca $pembaca): bool
    {
